<div class="container">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <a href="?page=tunjangankaryawan&act=add" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah
                Tunjangan Karyawan</a></button>
                ...
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="?page=tunjangankaryawan&act=edit&id=<?= $d['id_tunjangankaryawan']; ?>"
                                    class="btn btn-warning text-white text-right"> <i
                                        class="fa fa-user-edit text-white"></i> </a>
                                <a href="?page=tunjangankaryawan&act=del&id=<?= $d['id_tunjangankaryawan']; ?>"
