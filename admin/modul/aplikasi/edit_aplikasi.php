...
?>
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_instansi" value="<?= $d['nama_instansi']; ?>">
                        </div>
                        <div class="form-group">
    ...
    if (isset($_POST['updateAplikasi'])) {
        ...
        $updateaplikasi = mysqli_query($koneksi, "UPDATE tb_aplikasi SET 
			nama_instansi='$_POST[nama_instansi]',nama_aplikasi='$_POST[nama_aplikasi]' WHERE id_aplikasi='$_POST[id_aplikasi]' ") or die(mysqli_error($koneksi));
